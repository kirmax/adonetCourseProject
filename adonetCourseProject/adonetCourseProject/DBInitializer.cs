...
namespace adonetCourseProject
{
    class DBInitializer : DropCreateDatabaseAlways<DatabaseContext>
    {
        protected override void Seed(DatabaseContext context)
        {
            ...
            //context.SaveChanges();
            context.Employees.Add(new Employee { FirstName = "Akakiy", Salary = 10000, Reward = 0, Birthdate = DateTime.Parse("2004/04/15").Date, Account = new Account { Login = "ceo", Password = MD5Hash.GetMD5Hash("ceo") }, Position = new Position { Name = "CEO", Avaibility = false, Description = "Full control" } }); /*new Account { Login = "ivan01", Password = MD5Hash.GetMD5Hash("ceo") }*/
            ...
            context.Employees.Add(new Employee { FirstName = "Kirill", Salary = 1500, Reward = 1, Birthdate = DateTime.Parse("1945/04/15").Date, Account = null, Position = new Position { Name = "Director", Avaibility = false, Description = "Full control <3" } });
